...
class CirconscriptionFormationSeeder extends Seeder
{
    /**
    ...
    {
         $circonscription_formations = [
            // departement_formation_id => [circonscription_formations]
        ...
        foreach ($circonscription_formations as $departement_formation_id => $liste) {
            foreach ($liste as $nom) {
                DB::table('circonscription_formations')->insert([
                    'departement_formation_id' => $departement_formation_id,
                    'nom' => $nom,
                    'created_at' => now(),
                    'updated_at' => now(),
                ]);
